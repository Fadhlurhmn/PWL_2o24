...
class UserController extends Controller
{
    ...
    {
        // Ambil data pengguna yang akan diubah berdasarkan ID
        $user = UserModel::find($id);

        // Periksa apakah data pengguna ditemukan
        if (!$user) {
            // Jika tidak ditemukan, kembalikan respons dengan pesan error atau lakukan redirect
            // Sesuaikan dengan kebutuhan aplikasi Anda
            return redirect('/user')->with('error', 'User not found');
        }

        // Update data pengguna dengan data yang diterima dari formulir
        $user->username = $request->username;
        $user->nama = $request->nama;
        $user->password = Hash::make($request->password); // Jangan gunakan tanda kutip pada $request->password
